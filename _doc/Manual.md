...
```yml
# Site settings
title: Cody Blog             # title of your website
SEOTitle: Cody Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: zhoujiegl     # modify this account to yours
weibo_username: zhoujiegl      # the footer woule be auto-updated.
