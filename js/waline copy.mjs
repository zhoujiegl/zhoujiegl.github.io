...
class Oe {
	constructor(e = !1) {
		this.detached = e, this._active = !0, this.effects = [], this.cleanups = [], this.parent = je, !e && je && (this.index = (je.scopes || (je.scopes = []))
			.push(this) - 1)
	}
	get active() {
		return this._active
...
function dt(e = !1, t = !1) {
	return function(n, r, l) {
		...
		if ("__v_raw" === r && l === (e ? t ? Nt : Vt : t ? Ft : Pt)
			.get(n)) return n;
		const i = K(n);
		if (!e) {
...
const sr = e => e ? $l(e) ? El(e) || e.proxy : sr(e.parent) : null,
	...
	cr = {
		get({
			...
			const u = or[t];
			let p, d;
			return u ? ("$attrs" === t && Ye(e, 0, t), u(e)) : (p = o.__cssModules) && (p = p[t]) ? p : n !== M && Z(n, t) ? (s[t] = 4, n[t]) : (d = a.config.globalProperties, Z(d, t) ? d[t] : void 0)
		},
		set({
			_: e
		}, t, n) {
...
function $r(e, t, n, r) {
	...
	if (t)
		for (let a in t) {
			...
			const c = t[a];
			let u;
			l && Z(l, u = pe(a)) ? i && i.includes(u) ? (s || (s = {}))[u] = c : n[u] = c : Tn(e.emitsOptions, a) || a in r && c === r[a] || (r[a] = c, o = !0)
		}
	if (i) {
		const t = Gt(n),
			r = s || M;
...
const Fr = function(e, t) {
	var n;
	t && t.pendingBranch ? K(e) ? t.effects.push(...e) : t.effects.push(e) : (K(n = e) ? yn.push(...n) : wn && wn.includes(n, n.allowRecurse ? kn + 1 : kn) || yn.push(n), Cn())
};
...
function Vr(e) {
	return function(e, t) {
		...
		const {
			...
			w && v.beforeEnter(d), n(d, t, r), ((h = g && g.onVnodeMounted) || w || y) && Fr((() => {
			...
			g && (c = c ? c.concat(g) : g), null == e ? (n(p, r, l), n(d, r, l), _(t.children, r, d, i, o, a, c, u)) : h > 0 && 64 & h && f && e.dynamicChildren ? (C(e.dynamicChildren, f, r, i, o, a, c), (null != t.key || i && t === i.subTree) && Dr(e, t, !0)) : T(e, t, r, d, i, o, a, c, u)
		}, R = (e, t, n, r, l, i, s, o, a) => {
			...
			e.vnode = t, e.next = null,
				function(e, t, n, r) {
					...
					c && tt(e, "set", "$attrs")
				}(e, t.props, r, n), Mr(e, t.children, n), Je(), Sn(), Xe()
			...
			8 & f ? (16 & p && B(u, l, i), d !== u && c(n, d)) : 16 & p ? 16 & f ? O(u, d, n, r, l, i, s, o, a) : B(u, l, i, !0) : (8 & p && c(n, ""), 16 & f && _(d, n, r, l, i, s, o, a))
		}, j = (e, t, n, r, l, i, s, o, a) => {
			t = t || P;
			const c = (e = e || P)
				.length,
...
(kl = be()[bl]) || (kl = be()[bl] = []), kl.push((e => vl = e)), wl = e => {
...
function Oi(e, t, n, r = {}) {
		...
		v = null != (l = r.serializer) ? l : Ti[m],
		{
			...
			try {
				if (null == t) n.removeItem(e);
					...
					const r = v.write(t),
						l = n.getItem(e);
					l !== r && (n.setItem(e, r), p && p.dispatchEvent(new CustomEvent(ji, {
						detail: {
							key: e,
							oldValue: l,
							newValue: r,
	...
	return p && o && (Ri(p, "storage", k), Ri(p, ji, (function(e) {
		k(e.detail)
	}))), k(), f;
...
function rs(e, t) {
	...
	const n = {
		replace: (t, r) => (r = (r = r.source || r)
			.replace(ns, "$1"), e = e.replace(t, r), n),
...
class ms {
	...
	table(e) {
		...
		if (t) {
			...
			if (e.header.length === e.align.length) {
				...
				for (s = e.rows.length, n = 0; n < s; n++) e.rows[n] = ds(e.rows[n], e.header.length)
					.map((e => ({
						text: e
					})));
	...
	link(e) {
		...
		if (t) {
			...
			return n = n.trim(), /^</.test(n) && (n = this.options.pedantic && !/>$/.test(e) ? n.slice(1) : n.slice(1, -1)), gs(t, {
	...
	codespan(e) {
		...
		if (t) {
			...
			const n = /[^ ]/.test(e),
				r = /^ /.test(e) && / $/.test(e);
			return n && r && (e = e.substring(1, e.length - 1)), e = Yi(e, !0), {
				type: "codespan",
				raw: t[0],
				text: e
			}
	...
	autolink(e, t) {
		...
		if (n) {
			let e, r;
			return "@" === n[2] ? (e = Yi(this.options.mangle ? t(n[1]) : n[1]), r = "mailto:" + e) : (e = Yi(n[1]), r = e), {
				type: "link",
				raw: n[0],
				text: e,
				href: r,
...
vs.def = rs(vs.def)
	...
	.getRegex(), vs.bullet = /(?:[*+-]|\d{1,9}[.)])/, vs.listItemStart = rs(/^( *)(bull) */)
	.replace("bull", vs.bullet)
	.getRegex(), vs.list = rs(vs.list)
	.replace(/bull/g, vs.bullet)
	.replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))")
	.replace("def", "\\n+(?=" + vs.def.source + ")")
	.getRegex(), vs._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", vs._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/, vs.html = rs(vs.html, "i")
	.replace("comment", vs._comment)
	.replace("tag", vs._tag)
	.replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/)
	.getRegex(), vs.paragraph = rs(vs._paragraph)
	.replace("hr", vs.hr)
	...
	.replace("tag", vs._tag)
	.getRegex(), vs.blockquote = rs(vs.blockquote)
	...
	.replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)")
	.replace("tag", vs._tag)
	.getRegex(), vs.gfm.paragraph = rs(vs._paragraph)
	.replace("hr", vs.hr)
	.replace("heading", " {0,3}#{1,6} ")
	.replace("|lheading", "")
...
ys._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~", ys.punctuation = rs(ys.punctuation)
	.replace(/punctuation/g, ys._punctuation)
	.getRegex(), ys.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g, ys.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g, ys._comment = rs(vs._comment)
	.replace("(?:--\x3e|$)", "--\x3e")
	.getRegex(), ys.emStrong.lDelim = rs(ys.emStrong.lDelim)
	.replace(/punct/g, ys._punctuation)
	.getRegex(), ys.emStrong.rDelimAst = rs(ys.emStrong.rDelimAst, "g")
	.replace(/punct/g, ys._punctuation)
	.getRegex(), ys.emStrong.rDelimUnd = rs(ys.emStrong.rDelimUnd, "g")
	.replace(/punct/g, ys._punctuation)
	.getRegex(), ys._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, ys._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, ys._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, ys.autolink = rs(ys.autolink)
	.replace("scheme", ys._scheme)
	.replace("email", ys._email)
	.getRegex(), ys._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, ys.tag = rs(ys.tag)
	.replace("comment", ys._comment)
	.replace("attribute", ys._attribute)
	.getRegex(), ys._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, ys._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/, ys._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, ys.link = rs(ys.link)
	.replace("label", ys._label)
	.replace("href", ys._href)
	.replace("title", ys._title)
	.getRegex(), ys.reflink = rs(ys.reflink)
	.replace("label", ys._label)
	.replace("ref", vs._label)
	.getRegex(), ys.nolink = rs(ys.nolink)
	.replace("ref", vs._label)
	.getRegex(), ys.reflinkSearch = rs(ys.reflinkSearch, "g")
...
class bs {
	constructor(e) {
		this.tokens = [], this.tokens.links = Object.create(null), this.options = e || qi, this.options.tokenizer = this.options.tokenizer || new ms, this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
			inLink: !1,
			inRawBlock: !1,
			top: !0
		};
		...
		this.options.pedantic ? (t.block = vs.pedantic, t.inline = ys.pedantic) : this.options.gfm && (t.block = vs.gfm, this.options.breaks ? t.inline = ys.breaks : t.inline = ys.gfm), this.tokenizer.rules = t
	}
	static get rules() {
		return {
			block: vs,
	...
	inlineTokens(e, t = []) {
		...
		if (this.tokens.links) {
			...
			if (e.length > 0)
				for (; null != (i = this.tokenizer.rules.inline.reflinkSearch.exec(a));) e.includes(i[0].slice(i[0].lastIndexOf("[") + 1, -1)) && (a = a.slice(0, i.index) + "[" + fs("a", i[0].length - 2) + "]" + a.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
		}
		for (; null != (i = this.tokenizer.rules.inline.blockSkip.exec(a));) a = a.slice(0, i.index) + "[" + fs("a", i[0].length - 2) + "]" + a.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
		...
		for (; e;)
			...
			if (n = this.tokenizer.inlineText(l, ws)) e = e.substring(n.raw.length), "_" !== n.raw.slice(-1) && (o = n.raw.slice(-1)), s = !0, r = t[t.length - 1], r && "text" === r.type ? (r.raw += n.raw, r.text += n.text) : t.push(n);
			else if (e) {
				const t = "Infinite loop on byte: " + e.charCodeAt(0);
				if (this.options.silent) {
					console.error(t);
...
class Cs {
	constructor(e) {
		this.options = e || qi, this.options.renderer = this.options.renderer || new xs, this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new _s, this.slugger = new $s
	}
	static parse(e, t) {
		return new Cs(t)
			.parse(e)
	...
	parse(e, t = !0) {
		...
		const x = e.length;
		for (n = 0; n < x; n++)
			if (p = e[n], this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[p.type] && (k = this.options.extensions.renderers[p.type].call({
				parser: this
			}, p), !1 !== k || !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(p.type))) b += k || "";
			else switch (p.type) {
				case "space":
					continue;
				case "hr":
...
function As(e, t) {
	return (n, r, l) => {
		...
		if (r.async) return Promise.resolve(r.hooks ? r.hooks.preprocess(n) : n)
			.then((t => e(t, r)))
			.then((e => r.walkTokens ? Promise.all(Rs.walkTokens(e, r.walkTokens))
				.then((() => e)) : e))
			.then((e => t(e, r)))
...
Rs.options = Rs.setOptions = function(e) {
	...
	return Rs.defaults = {
		...Rs.defaults,
		...e
	}, t = Rs.defaults, qi = t, Rs
}, Rs.getDefaults = Wi, Rs.defaults = qi, Rs.use = function(...e) {
	...
	e.forEach((e => {
		...
		if (n.async = Rs.defaults.async || n.async || !1, e.extensions && (e.extensions.forEach((e => {
		...
		if (e.hooks) {
			...
			for (const n in e.hooks) {
				...
				Ss.passThroughHooks.has(n) ? t[n] = l => {
					if (Rs.defaults.async) return Promise.resolve(e.hooks[n].call(t, l))
						.then((e => r.call(t, e)));
	...
	let n = [];
	for (const r of e) switch (n = n.concat(t.call(Rs, r)), r.type) {
		case "table":
	...
	return n
}, Rs.parseInline = As(bs.lexInline, Cs.parseInline), Rs.Parser = Cs, Rs.parser = Cs.parse, Rs.Renderer = xs, Rs.TextRenderer = _s, Rs.Lexer = bs, Rs.lexer = bs.lex, Rs.Tokenizer = ms, Rs.Slugger = $s, Rs.Hooks = Ss, Rs.parse = Rs;
const Es = /\$.*?\$/,
	zs = /^\$(.*?)\$/,
	Ls = /^(?:\s{0,3})\$\$((?:[^\n]|\n[^\n])+?)\n{0,1}\$\$/,
...
to.ReCaptchaInstance = lo, Object.defineProperty(eo, "__esModule", {
	value: !0
...
var oo = function() {
	...
	return e.load = function(t, n) {
		...
		if (e.getLoadingState() === io.LOADED) return e.instance.getSiteKey() === t ? Promise.resolve(e.instance) : Promise.reject(new Error("reCAPTCHA already loaded with different site key!"));
		if (e.getLoadingState() === io.LOADING) return t !== e.instanceSiteKey ? Promise.reject(new Error("reCAPTCHA already loaded with different site key!")) : new Promise((function(t, n) {
...
eo.load = oo.load, eo.getInstance = oo.getInstance,
	function(e) {
...
var ko = Kn({
		...
		setup(e, {
			...
			return Xn((() => {
			...
			})), er((() => c ? .())), (e, t) => a.value.length ? (Gr(), Yr("div", po, [sl("div", {
				class: "wl-reaction-title",
				textContent: Ie(s.value.reactionTitle)
			}, null, 8, ho), sl("ul", fo, [(Gr(!0), Yr(Hr, null, ir(a.value, (({
				active: e,
				icon: t,
				desc: s
			}, o) => (Gr(), Yr("li", {
				...
				src: t,
				alt: s
			}, null, 8, vo), l.value === o ? (Gr(), el(on(qs), {
				key: 0,
		...
		return e && Array.prototype.forEach.call(e.length ? e : [e], (function(e) {
			return function(e) {
				if (e && e.nodeName && "TEXTAREA" === e.nodeName && !_o.has(e)) {
					...
					e.addEventListener("autosize:destroy", i), e.addEventListener("autosize:update", o), e.addEventListener("input", l), window.addEventListener("resize", o), e.style.overflowX = "hidden", e.style.wordWrap = "break-word", _o.set(e, {
						destroy: i,
						update: o
					}), o()
				}
...
var zo = Kn({
		...
		setup(e, {
			...
			return Xn((() => {
				...
				key: t
			}, [i.value[e.items[t].src] ? ul("v-if", !0) : (Gr(), el(on(qs), {
				key: 0,
				size: 36,
				style: {
					margin: "20px auto"
		...
		setup(e, {
			...
			const l = xr("config"),
				...
				M = e => {
					...
					return j(t), E.value = !0, Promise.resolve()
				...
				N = async () => {
					...
					if (v.comment) {
						...
						v.comment = Is(v.comment, m.value.map), r.replyId && r.rootId && (v.pid = r.replyId, v.rid = r.rootId, v.at = r.replyUser), E.value = !0;
						try {
							h && (v.recaptchaV3 = await (e => {
								...
								.execute("social")), f && (v.turnstile = await (w = f, {
									execute: async e => {
										const {
											load: t
										} = Mi("https://challenges.cloudflare.com/turnstile/v0/api.js", void 0, {
											async: !1
										});
										await t();
					...
					p.value ? .contains(e.target) || d.value ? .contains(e.target) || (y.value = !1), h.value ? .contains(e.target) || f.value ? .contains(e.target) || (w.value = !1)
				}, q = async e => {
					const {
						scrollTop: t,
						clientHeight: n,
			...
			return Xn((() => {
				document.body.addEventListener("click", W), window.addEventListener("message", K), r.edit ? .objectId && (i.value = r.edit.orig), Hn(w, (async e => {
					if (!e) return;
					...
					R.value = e, b.value = Ts(e, {
						emojiMap: m.value.map,
						highlighter: t,
						texRenderer: n
					}), x.value = (e => ((e => e.match(/[\w\d\s,.\u00C0-\u024F\u0400-\u04FF]+/giu))(e) ? .reduce(((e, t) => e + ("" === t.trim() ? 0 : t.trim()
						.split(/\s+/u)
						.length)), 0) || 0) + ((e => e.match(/[\u4E00-\u9FD5]/gu))(e) ? .length || 0))(e), e ? Ao(c.value) : Ao.destroy(c.value)
				}), {
					immediate: !0
				}), Hn((() => l.value.emoji), (e => {
					return (t = e, Promise.all(t.map((e => "string" == typeof e ? Fi(A(e)) : Promise.resolve(e))))
							.then((e => {
								const t = {
									tabs: [],
									map: {}
			...
			})), (e, t) => (Gr(), Yr("div", Io, ["disable" !== on(l)
				.login && I.value && !e.edit ? .objectId ? (Gr(), Yr("div", To, [sl("div", jo, [sl("button", {
					type: "submit",
					class: "wl-logout-btn",
					...
					textContent: Ie(on(o)
						.display_name)
				}, null, 8, Po)])) : ul("v-if", !0), sl("div", Fo, ["force" !== on(l)
					.login && on(l)
					.meta.length && !I.value ? (Gr(), Yr("div", {
						...
						[Yl, on(i)]
					]), qn(sl("div", Ho, [Bo, sl("h4", null, Ie(L.value.preview) + ":", 1), sl("div", {
						class: "wl-content",
						innerHTML: b.value
					}, null, 8, Wo)], 512), [
						[ci, k.value]
					]), sl("div", qo, [sl("div", Zo, [sl("a", Ko, [ol(on(Ds))]), qn(sl("button", {
						...
						.search ? (Gr(), Yr("button", {
							...
							}, null, 10, ra)])) : ul("v-if", !0), cl("  " + Ie(L.value.word), 1)
						]), "disable" === on(l)
						...
						.login || I.value ? (Gr(), Yr("button", {
							...
							key: 1
						}, [cl(Ie(L.value.submit), 1)], 64))], 8, ia)) : ul("v-if", !0)
					]), sl("div", {
						ref_key: "gifPopupRef",
						ref: f,
					...
					}, null, 40, sa), _.list.length ? (Gr(), el(Lo, {
						key: 0,
						items: _.list,
						"column-width": 200,
						gap: 6,
						...
						onScroll: q
					}, null, 8, ["items"])) : ul("v-if", !0), _.loading ? (Gr(), Yr("div", oa, [ol(on(qs), {
						size: 30
					})])) : ul("v-if", !0)], 2), sl("div", {
						...
						key: e.name
					}, [t === v.value ? (Gr(), Yr("div", aa, [(Gr(!0), Yr(Hr, null, ir(e.items, (e => (Gr(), Yr("button", {
						key: e,
						type: "button",
						title: e,
						onClick: t => j(`:${e}:`)
					...
					}, null, 8, ua)) : ul("v-if", !0)], 8, ca)))), 128))])) : ul("v-if", !0)], 64)))), 128)), m.value.tabs.length > 1 ? (Gr(), Yr("div", pa, [(Gr(!0), Yr(Hr, null, ir(m.value.tabs, ((e, t) => (Gr(), Yr("button", {
						key: e.name,
						type: "button",
						class: Ae(["wl-tab", {
							active: v.value === t
						...
						loading: "lazy",
						referrerPolicy: "no-referrer"
					}, null, 8, ha)], 10, da)))), 128))])) : ul("v-if", !0)], 2)])
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return Gr(), Yr("div", {
				...
				class: "wl-card-item"
			}, [sl("div", ya, [e.comment.avatar ? (Gr(), Yr("img", {
				key: 0,
				src: e.comment.avatar
			}, null, 8, wa)) : ul("v-if", !0), e.comment.type ? (Gr(), el(on(Ws), {
				key: 1
			})) : ul("v-if", !0)]), sl("div", ka, [sl("div", ba, [a.value ? (Gr(), Yr("a", {
				key: 0,
				class: "wl-nick",
				href: a.value,
				target: "_blank",
				rel: "nofollow noopener noreferrer"
			}, Ie(e.comment.nick), 9, xa)) : (Gr(), Yr("span", _a, Ie(e.comment.nick), 1)), "administrator" === e.comment.type ? (Gr(), Yr("span", {
				key: 2,
				class: "wl-badge",
				textContent: Ie(o.value.admin)
			}, null, 8, $a)) : ul("v-if", !0), e.comment.label ? (Gr(), Yr("span", {
				key: 3,
				class: "wl-badge",
				textContent: Ie(e.comment.label)
			}, null, 8, Ca)) : ul("v-if", !0), e.comment.sticky ? (Gr(), Yr("span", {
				key: 4,
				class: "wl-badge",
				textContent: Ie(o.value.sticky)
			}, null, 8, Sa)) : ul("v-if", !0), void 0 !== e.comment.level && e.comment.level >= 0 ? (Gr(), Yr("span", {
				key: 5,
			...
			}, null, 8, Ra), sl("div", Ea, [p.value || d.value ? (Gr(), Yr("button", {
				key: 0,
				type: "button",
				class: "wl-edit",
				onClick: t[0] || (t[0] = () => e.$emit("edit", e.comment))
			}, [ol(on(Bs))])) : ul("v-if", !0), p.value || d.value ? (Gr(), Yr("button", {
				key: 1,
				type: "button",
				class: "wl-delete",
			...
			}, [ol(on(Hs))], 10, Ia)])]), sl("div", Ta, [e.comment.addr ? (Gr(), Yr("span", {
				key: 0,
				class: "wl-addr",
				"data-value": e.comment.addr,
				textContent: Ie(e.comment.addr)
			}, null, 8, ja)) : ul("v-if", !0), e.comment.browser ? (Gr(), Yr("span", {
				key: 1,
				class: "wl-browser",
				"data-value": e.comment.browser,
				textContent: Ie(e.comment.browser)
			}, null, 8, Oa)) : ul("v-if", !0), e.comment.os ? (Gr(), Yr("span", {
				key: 2,
				class: "wl-os",
				"data-value": e.comment.os,
				textContent: Ie(e.comment.os)
			}, null, 8, Ua)) : ul("v-if", !0)]), f.value ? ul("v-if", !0) : (Gr(), Yr("div", {
				key: 0,
				class: "wl-content",
				innerHTML: e.comment.comment
			}, null, 8, Ma)), p.value && !f.value ? (Gr(), Yr("div", Pa, [sl("span", Fa, [(Gr(), Yr(Hr, null, ir(n, (t => sl("button", {
				key: t,
				type: "submit",
			...
			}, null, 10, Va))), 64))]), p.value && !e.comment.rid ? (Gr(), Yr("button", {
				key: 0,
				type: "submit",
			...
			}, null, 8, ["edit", "reply-id", "reply-user", "root-id"])], 2)) : ul("v-if", !0), e.comment.children ? (Gr(), Yr("div", Na, [(Gr(!0), Yr(Hr, null, ir(e.comment.children, (n => (Gr(), el(r, {
				key: n.objectId,
				comment: n,
				reply: e.reply,
				edit: e.edit,
		...
		setup(e) {
			...
			! function(e, t = {}) {
				...
				const c = () => {
						...
						e.isConnected || (e.id = s, t.media && (e.media = t.media), r.head.appendChild(e)), n.value || (a = Hn(o, (t => {
							e.textContent = t
						}), {
							immediate: !0
						}), n.value = !0)
			...
			const j = e => {
				...
				V = async ({
					...
					await (({
						...
						token: d.value ? .token,
						objectId: e
					}), b.value.some(((t, n) => t.objectId === e ? (b.value = b.value.filter(((e, t) => t !== n)), !0) : t.children.some(((r, l) => r.objectId === e && (b.value[n].children = t.children.filter(((e, t) => t !== l)), !0)))))
				}, H = async e => {
					const {
						serverURL: t,
						lang: n
			...
			return function(e, t) {
			...
			})), er((() => T ? .())), (e, t) => (Gr(), Yr("div", Ba, [ol(xo), _.value ? ul("v-if", !0) : (Gr(), el(ma, {
				key: 0,
				onLog: U,
				onSubmit: F
			})), sl("div", Wa, [sl("div", qa, [g.value ? (Gr(), Yr("span", {
				key: 0,
				class: "wl-num",
				textContent: Ie(g.value)
			}, null, 8, Za)) : ul("v-if", !0), cl(" " + Ie(R.value.comment), 1)]), sl("ul", Ka, [(Gr(!0), Yr(Hr, null, ir(on(u), (e => (Gr(), Yr("li", {
				key: e,
				class: Ae([e === w.value ? "active" : ""]),
				onClick: t => (e => {
					w.value !== e && (w.value = e, U())
				})(e)
			}, Ie(R.value[e]), 11, Ga)))), 128))])]), sl("div", Qa, [(Gr(!0), Yr(Hr, null, ir(b.value, (e => (Gr(), el(Da, {
				key: e.objectId,
				"root-id": e.objectId,
				comment: e,
				reply: _.value,
				...
				onSticky: N,
				onLike: H
			}, null, 8, ["root-id", "comment", "reply", "edit"])))), 128))]), "error" === f.value ? (Gr(), Yr("div", Ja, [sl("button", {
				type: "button",
				class: "wl-btn",
				onClick: U,
				...
				key: 2
			}, ["loading" === f.value ? (Gr(), Yr("div", Ya, [ol(on(qs), {
				size: 30
			})])) : b.value.length ? m.value < v.value ? (Gr(), Yr("div", tc, [sl("button", {
				type: "button",
				class: "wl-btn",
				onClick: O,
				textContent: Ie(R.value.more)
			}, null, 8, nc)])) : ul("v-if", !0) : (Gr(), Yr("div", {
				key: 1,
				class: "wl-empty",
...
export {
	uc as RecentComments, pc as UserList, Os as commentCount, k as defaultLocales, cc as init, ac as pageviewCount, Ha as version
};
